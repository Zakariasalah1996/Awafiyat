...
source = Path('/home/ubuntu/verify_global_recipe_batch_two.json')
target = Path('/home/ubuntu/awafiyat-mobile/data/recipe-batch-2.json')
...
for item in items:
    ...
    data = json.loads(output['recipe_data'])
    data['source_url'] = output['source_url']
    recipes.append(data)
