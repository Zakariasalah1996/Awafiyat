...
research_path = Path('/home/ubuntu/research_arab_recipe_batch_six.json')
...
(root / 'data/recipe-batch-6.json').write_text(json.dumps({'recipes': recipes}, ensure_ascii=False, indent=2) + '\n', encoding='utf-8')
print(len(recipes))
